...
def boot_session(bootinfo):
	...
	bootinfo.custom_design = {
		...
		"dark_success_color": settings.dark_success_color,
		"dark_danger_color": settings.dark_danger_color,
		...
		"dark_sidebar_background_color": settings.dark_sidebar_background_color,
		"dark_sidebar_text_color": settings.dark_sidebar_text_color,
		"dark_navbar_background_color": settings.dark_navbar_background_color,
		"dark_navbar_text_color": settings.dark_navbar_text_color,
		"number_card_background": settings.number_card_background,
		"dark_number_card_background": settings.dark_number_card_background,
